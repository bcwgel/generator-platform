package cn.stylefeng.guns.generator.modular.guns;

import cn.stylefeng.guns.generator.core.generator.param.ContextParam;
import cn.stylefeng.guns.generator.modular.guns.controller.GunsControllerGenerator;
import cn.stylefeng.guns.generator.modular.guns.html.GunsPageAddGenerator;
import cn.stylefeng.guns.generator.modular.guns.html.GunsPageEditGenerator;
import cn.stylefeng.guns.generator.modular.guns.html.GunsPageIndexGenerator;
import cn.stylefeng.guns.generator.modular.guns.js.GunsPageAddJsGenerator;
import cn.stylefeng.guns.generator.modular.guns.js.GunsPageEditJsGenerator;
import cn.stylefeng.guns.generator.modular.guns.js.GunsPageIndexJsGenerator;
import cn.stylefeng.guns.generator.modular.guns.mybatisplus.GunsMpGenerator;
import cn.stylefeng.guns.generator.modular.guns.sqls.GunsMenuSqlGenerator;
...
public class GunsExecutor {
    ...
    public static void main(String[] args) {
        ...
        contextParam.setJdbcPassword("Yu_8168907");
        contextParam.setJdbcUrl("jdbc:mysql://47.96.16.46:3306/wt?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=CTT");
        contextParam.setOutputPath("temp");
        contextParam.setAuthor("wangbencheng");
        contextParam.setProPackage("com.wentuo.wt");

        MpParam mpContextParam = new MpParam();
        mpContextParam.setGeneratorInterface(true);
        mpContextParam.setIncludeTables(new String[]{"case_detail"});
