package cn.stylefeng.guns.generator.modular.guns.mybatisplus;
...
public class GunsMpGenerator extends AbstractMpGenerator {
    ...
    protected void beforeGeneration() {
        ...
        this.mpContextParam.setGeneratorInterface(false);
...
//            globalConfig.setServiceImplName("%sServiceImpl");
        ...
        if (!this.mpContextParam.getGeneratorInterface()) {
            ...
            templateConfig.setServiceImpl("/mpTemplates/serviceImpl.java");
        } else {
